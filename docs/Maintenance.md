...
| AWS | Best effort | @EmmEff | Limited development/maintenance. Daily e2e CI. Works with non-TEE and AMD SEV-SNP instances. |
| GCP | Best effort| @EmmEff | No upstream CI. Limited development/maintenance. Documentation exists. Works with SEV-SNP and TDX instances |
