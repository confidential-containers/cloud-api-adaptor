...
> **Note**: Now Confidential Computing instances [are only availvable](https://www.alibabacloud.com/help/en/ecs/user-guide/build-a-tdx-confidential-computing-environment) in `cn-beijing` region within zone `cn-beijing-i`. 
...
If you want to build CAA daemonset image yourself:
    ...
    ```sh
    export registry=registry.cn-shanghai.aliyuncs.com/xynnn007
