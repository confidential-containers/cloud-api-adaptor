...
>Notes:
 * The AWS credentials are obtained from the CLI [configuration files](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-files.html). **Important**: the access key and secret are recorded in plain-text in [nstall/charts/peerpods/providers/aws-secrets.yaml](../../install/charts/peerpods/providers/aws-secrets.yaml)
