...
> [!WARNING]
> If you want to experiment with attestation, you will also need access to a [Trustee](https://github.com/confidential-containers/trustee) service that is configured to verify TDX evidence. You also need to make sure that your configured peer pod VM image includes the TDX runtime libraries and attestation agent.
