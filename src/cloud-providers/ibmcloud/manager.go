...
func (_ *Manager) ParseCmd(flags *flag.FlagSet) {
	...
	flags.StringVar(&ibmcloudVPCConfig.DedicatedHostID, "dedicated-host-id", "", "Dedicated Host ID")
	flags.StringVar(&ibmcloudVPCConfig.DedicatedHostGroupID, "dedicated-host-group-id", "", "Dedicated Host Group ID")
...
func (_ *Manager) LoadEnv() {
	...
	provider.DefaultToEnv(&ibmcloudVPCConfig.DedicatedHostID, "IBMCLOUD_DEDICATED_HOST_ID", "")
	provider.DefaultToEnv(&ibmcloudVPCConfig.DedicatedHostGroupID, "IBMCLOUD_DEDICATED_HOST_GROUP_ID", "")
