...
// PeerPodIPInfo contains IP allocation information from PeerPod resources
// Used by GetBYOMAllocatedIPs fallback method
type PeerPodIPInfo struct {
	Name         string      // PeerPod name
	Namespace    string      // PeerPod namespace
	UID          string      // PeerPod UID
	AllocationID string      // Derived from pod name and sandbox ID (may be empty for fallback)
