...
# confidentialcontainers.org/peerpod-ctrl-bundle:$VERSION and confidentialcontainers.org/peerpod-ctrl-catalog:$VERSION.
IMAGE_TAG_BASE ?= confidentialcontainers.org/peerpod-ctrl
...
docker-build: test ## Build docker image with the manager.
	docker build -t ${IMG} . --build-arg CGO_ENABLED=$(CGO_ENABLED) --build-arg GOFLAGS=$(GOFLAGS)
