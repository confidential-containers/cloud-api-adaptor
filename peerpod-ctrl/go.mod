...
require (
	github.com/confidential-containers/cloud-api-adaptor v0.5.1-0.20230504043629-580abeb128aa
...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20230606170044-338e18e4fd46 // indirect
