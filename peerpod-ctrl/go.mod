...
require (
	github.com/confidential-containers/cloud-api-adaptor v0.6.0
...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20230720145636-9e036108b4d5 // indirect
